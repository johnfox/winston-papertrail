...
if (Number(winston.version.split('.')[0]) < 3) {
  throw new Error('Winston3-papetrail requires winston >= 3.0.0');
}
...
//
util.inherits(Papertrail, Transport);
...
Papertrail.prototype.log = function (info, callback) {
    ...
    //don't send any metadata to papertrail, formater should take care of message content
    // if (meta) {
